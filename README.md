...
Use o perfil `prod` e defina `DATABASE_URL`, `DATABASE_USERNAME`,
`DATABASE_PASSWORD`, `BEMDOAR_JWT_SECRET`, `BEMDOAR_CORS_ORIGEM` e
`BEMDOAR_UPLOAD_DIRETORIO`. O arquivo `application-prod.properties` desativa
o console H2 e nao contem segredo padrao. HTTPS deve ser terminado pelo proxy
ou servico de hospedagem, que deve encaminhar os cabecalhos `Forwarded`.
